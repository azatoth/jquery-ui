...
(function($, undefined) {
	...
	$.widget( "ui.sortable", $.ui.mouse, {
		...
		_createHelper: function( event ) {
			...
			var o = this.options;
			if( $.isFunction(o.helper) ) {
				var helper = $(o.helper.apply(this.element[0], [event, this.currentItem]));
			} else if ( o.helper == 'clone' ) {
				var helper = this.currentItem.clone();
			} else {
		...
		_getParentOffset: function() {
			...
			if (
				this.cssPosition == 'absolute' && this.scrollParent[0] != document &&
		...
		_clear: function( event, noPropagation ) {
			...
			if ( !noPropagation && this.fromOutside ) {
			...
			if ( !$.ui.contains(this.element[0], this.currentItem[0]) ) { //Node was moved out of the current element
				...
				for ( var i = this.containers.length - 1; i >= 0; i-- ) {
					if ( !noPropagation && $.ui.contains(this.containers[i].element[0], this.currentItem[0]) ) {
